...
ic-wasm target/wasm32-unknown-unknown/release/bob_minter_v2.wasm -o target/wasm32-unknown-unknown/release/bob_minter_v2.wasm metadata candid:service -f minter-v2/bob.did -v public
